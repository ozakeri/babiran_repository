...
public class FullBanner extends Fragment {
    ...
    public FullBanner(String id , String prev){

        this.id = id ;
        this.prev = prev ;
        Log.e("prev,id",prev + " " + id);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        v = inflater.inflate(R.layout.full_banner, container, false);


        fullbanner = (ListView) v.findViewById(R.id.FullBannerList);
