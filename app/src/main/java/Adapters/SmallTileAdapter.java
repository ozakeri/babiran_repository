...
public class SmallTileAdapter extends BaseAdapter {
    RequestQueue queue;
    DatabaseHandler db ;
    String id_user = "-1";
    Context context;
    ...
    public SmallTileAdapter(Context context, ArrayList<Product> products , String prev){
    ...
    public View getView(final int i, View convertView, ViewGroup viewGroup) {
        ...
        if (convertView == null) {
            ...
            convertView = this.inflater.inflate(R.layout.small_tile_item,
                    viewGroup, false);


            holder.name = (MyTextView) convertView.findViewById(R.id.small_tile_txt_name);
            holder.img = (ImageView) convertView.findViewById(R.id.small_tile_img);
            holder.item_Button = (RelativeLayout) convertView.findViewById(R.id.small_tile_item_button) ;
            holder.addToBasket = (RelativeLayout) convertView.findViewById(R.id.addToSmall) ;
        ...
        holder.item_Button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(prev.equals("first")){
                    ProductFragment.prev = "FirstSmallTile" ;
                    ...
                    ProductFragment.prev = "SecondSmallTile" ;
                    AppConfig.fragmentManager.beginTransaction().replace(R.id.Productcontainer, new ProductFragment(productArray.get(i)),ProductFragment.prev).commit();
                    MainActivity.smalltile_banner.setVisibility(View.INVISIBLE);
                }
                else if(prev.equals("third")){
                    ProductFragment.prev = "ThirdSmallTile" ;
                    AppConfig.fragmentManager.beginTransaction().replace(R.id.Productcontainer, new ProductFragment(productArray.get(i)),ProductFragment.prev).commit();
                    MainActivity.smalltile_banner.setVisibility(View.INVISIBLE);
                }
                else if(prev.equals("fourth")){
                    ProductFragment.prev = "FourthSmallTile" ;
                    AppConfig.fragmentManager.beginTransaction().replace(R.id.Productcontainer, new ProductFragment(productArray.get(i)),ProductFragment.prev).commit();
                    MainActivity.smalltile_banner.setVisibility(View.INVISIBLE);
                }
