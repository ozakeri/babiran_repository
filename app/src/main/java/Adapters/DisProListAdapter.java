...
public class DisProListAdapter extends BaseAdapter {
    ...
    public View getView(final int i, View convertView, ViewGroup viewGroup) {
        ...
        if (convertView == null)
        {
            ...
            convertView = this.inflater.inflate(R.layout.dis_pro_item_new,
                    viewGroup, false);

            holder.name = (MyTextView) convertView.findViewById(R.id.dis_pro_txt_name);
            holder.img = (ImageView) convertView.findViewById(R.id.dis_pro_img);
