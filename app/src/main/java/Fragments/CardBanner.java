...
public class CardBanner extends Fragment {
    ...
    public CardBanner(String id , String prev){
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        v = inflater.inflate(R.layout.card_banner, container, false);


        cardbanner = (ListView) v.findViewById(R.id.CardBannerList);


        if (!id.equals("") && !id.equals("null") && id != null) {
            MainActivity.card_banner.setVisibility(View.VISIBLE);
